...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/kw_assets/images/favicon.ico') }}">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="http://khabarwala.pk/">
    <meta name="twitter:title" content="khabarwala news">
    <meta name="twitter:description" content="breaking news">
    <meta name="twitter:image" content="http://khabarwala.pk/demo/public/kw_assets/images/extras/Logos/android-icon-72x72.png">
    <!-- CSS
    ============================================ -->
    <!-- google fonts -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i,700,700i,900"
        rel="stylesheet">
    <!-- Bootstrap CSS -->
    <link href="{{ asset('public/kw_assets/css/vendor/bootstrap.min.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/kw_assets/css/vendor/bicon.min.css') }}" rel="stylesheet" type="text/css" >
    <!-- Flat Icon CSS -->
    <link href="{{ asset('public/kw_assets/css/vendor/flaticon.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/kw_assets/css/plugins/plyr.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/kw_assets/css/plugins/slick.min.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/kw_assets/css/plugins/nice-select.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/kw_assets/css/plugins/perfect-scrollbar.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/kw_assets/css/plugins/lightgallery.min.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/kw_assets/css/plugins/owl.carousel.min.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/kw_assets/css/plugins/owl.theme.default.min.css') }}" rel="stylesheet" type="text/css" >
    <link href="{{ asset('public/kw_assets/css/style.css') }}" rel="stylesheet" type="text/css" >
...
<body>
            ...
            <div class="row">
                <div class="col-12 d-lg-block d-none">
                    ...
                    <video width="100%" autoplay muted loop>
                            <source src="{{ asset('public/kw_assets/1.mp4') }}" type="video/mp4" />
                            <source src="{{ asset('public/kw_assets/1.ogg') }}" type="video/ogg" />
                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="logo d-lg-none">
                            <img src="{{ asset('public/kw_assets/images/extras/Logos/android-icon-72x72.png') }}" alt="">
                        </div>
        ...
        <div class="main-wrapper pt-4">
                                ...
                                <div class="profile-thumb">
                                    <a href="#">
                                        <figure class="profile-thumb-middle">
                                            <img src="{{ asset('public/kw_assets/images/extras/Logos/android-icon-72x72.png') }}"
                                                alt="profile picture">
                                        </figure>
                                    </a>
                                </div>
                                ...
                                <div class="post-meta">
                                    ...
                                    <ul class="comment-share-meta">
                                        ...
                                        <a class="twitter-share-button" target="_blank" 
                                           href="https://twitter.com/intent/tweet?url=http://khabarwala.pk/demo/viewpostdetails/4"
                                            data-size="large">
                                        Tweet</a>
                                        </li>
                                        <li>
                    ...
                    <div class='title'>
                        <div class="card" id="ahm_card_{{$val->post_id}}">
                            ...
                            <div class="post-title d-flex align-items-center">
                                ...
                                <div class="posted-author">
                                    <h6 class="author"><a href="{{ URL::to('/webpost')}}">Khabar Wala News</a></h6>
                                    @if($gettime != "")
                                    <span class="post-time">{{$gettime}} ago</span>
                                    @endif
                                </div>
                    ...
                    <div class="col-lg-4">
                        <?php
                            ...
                            foreach ($covid as $covids) {
                                // foreach ($covids as $covidss) {
                                    $getresult[] = $covids;
                                // }
                            }
                            // $arrayget = array_pop($getresult);
                            // print_r($getresult[1]['NewConfirmed']);
                        ?>
                        <div class="adds">
                            <img src="{{ asset('public/kw_assets/images/adds/add_one.jpg') }}" alt="">
                        </div>
                        <div class="covid-19-updates">
                               <h3>Covid-19 Updates</h3>
                            <ul>
                                <li class="confirmed">
                                    <div>New Confirmed Cases: </div>
                                    <div class="text-right">{{$getresult[1]['NewConfirmed']}}</div>
                                </li>
                                <li class="confirmed">
                                    <div>Total Confirmed Cases: </div>
                                    <div class="text-right">{{$getresult[1]['TotalConfirmed']}}</div>
                                </li>
                                <li class="divider"></li>
                                <li class="deaths">
                                    <div>New Deaths: </div>
                                    <div class="text-right">{{$getresult[1]['NewDeaths']}}</div>
                                </li>
                                <li class="deaths">
                                    <div>Total Deaths: </div>
                                    <div class="text-right">{{$getresult[1]['TotalDeaths']}}</div>
                                </li>
                                <li class="divider"></li>
                                <li class="recovered">
                                    <div>New Recovered: </div>
                                    <div class="text-right">{{$getresult[1]['NewRecovered']}}</div>
                                </li>
                                <li class="recovered">
                                    <div>Total Recovered: </div>
                                    <div class="text-right">{{$getresult[1]['TotalRecovered']}}</div>
                                </li>
                            </ul>
                        </div>
                        <div class="hot-news">
                        ...
                        <div class="our_androId_app">
                                ...
                                <a href="">
                                    <img src="{{ asset('public/kw_assets/images/extras/Logos/android-icon-72x72.png') }}" alt="">
                                    <img src="{{ asset('public/kw_assets/images/playstore/play-store.png') }}" alt="">
            ...
            <section id="ahm_loginin_with_section">
                <div class="popup text-center">
                    ...
                    <figure>
                        <img src="{{ asset('public/kw_assets/images/extras/Logos/ms-icon-310x310.png') }}" alt="">
                    </figure>
    ...
    <div class="logo_section">
        <img src="{{ asset('public/kw_assets/images/footer/logo.gif') }}" alt="">
    </div>
        <footer>
...
============================================ -->
        <link href="{{ asset('public/kw_assets/css/vendor/bootstrap.min.css') }}" rel="stylesheet" type="text/css" >
    <!-- Modernizer JS -->
    <script src="{{ asset('public/kw_assets/js/vendor/modernizr-3.6.0.min.js') }}"></script>
    <!-- jQuery JS -->
    <script src="{{ asset('public/kw_assets/js/vendor/jquery-3.3.1.min.js') }}"></script>
    <!-- Popper JS -->
    <script src="{{ asset('public/kw_assets/js/vendor/popper.min.js') }}"></script>
    <!-- Bootstrap JS -->
    <script src="{{ asset('public/kw_assets/js/vendor/bootstrap.min.js') }}"></script>
    <!-- Slick Slider JS -->
    <script src="{{ asset('public/kw_assets/js/plugins/slick.min.js') }}"></script>
    <!-- nice select JS -->
    <script src="{{ asset('public/kw_assets/js/plugins/nice-select.min.js') }}"></script>
    <!-- audio video player JS -->
    <script src="{{ asset('public/kw_assets/js/plugins/plyr.min.js') }}"></script>
    <!-- perfect scrollbar js -->
    <script src="{{ asset('public/kw_assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
    <!-- light gallery js -->
    <script src="{{ asset('public/kw_assets/js/plugins/lightgallery-all.min.js') }}"></script>
    <!-- image loaded js -->
    <script src="{{ asset('public/kw_assets/js/plugins/imagesloaded.pkgd.min.js') }}"></script>
    <!-- isotope filter js -->
    <script src="{{ asset('public/kw_assets/js/plugins/isotope.pkgd.min.js') }}"></script>
    <!-- jquery autosize -->
    <script src="{{ asset('public/kw_assets/js/vendor/jquery_auto_resize.js') }}"></script>
    <!-- owl carousel -->
    <script src="{{ asset('public/kw_assets/js/plugins/owl.carousel.min.js') }}"></script>
    <!-- Main JS -->
    <script src="{{ asset('public/kw_assets/js/main.js') }}"></script>
    <script>
        ...
        function pakistan($id)
        {
            ...
            // alert($id);
            // $.get('{{ URL::to("/categorieswebpost")}}/'+$id);
        }
