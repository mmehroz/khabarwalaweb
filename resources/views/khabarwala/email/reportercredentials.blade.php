...
<head>
        ...
        <title>Login Credentials - Khabarwala</title>
							        ...
							        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							          <tr>
							            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
							              <p style="margin: 0; color: #000;">Hello <b>{{$name}}</b></p><br>
							              <p style="margin: 0; color: #000;">Welcome To Khabarwala News, Use Below Credentials To Start Posting On Khabarwala.</p>
							            </td>
							          </tr>
							          <tr>
							          ...
							          <tr>
							            <td align="center" bgcolor="#ffffff" style="border-radius: 6px;">
							      			<a href="http://khabarwala.pk/demo/" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; background-color: #c44f55;text-decoration: none; border-radius: 6px;">Visit Khabarwala For Posting</a>
							            </td>
							          </tr>
							          <tr>
